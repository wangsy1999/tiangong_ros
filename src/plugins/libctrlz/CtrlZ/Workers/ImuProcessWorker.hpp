    ...
    public:
        ...
        void TaskCycleBegin() override
        {
            ImuValVec Acc = {
                ...
                static_cast<ImuPrecision>(this->ImuInstance->GetAccZ())}; // 获取Acc数据
            ImuValVec LastAcc;
            ...
            ImuValVec Gyro = {
                ...
                static_cast<ImuPrecision>(this->ImuInstance->GetGyroZ())}; // 获取Gyro数据
            ImuValVec LastGyro;
            ...
            ImuValVec Mag = {
                ...
                static_cast<ImuPrecision>(this->ImuInstance->GetYaw())}; // 获取Mag数据
